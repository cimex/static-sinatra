...
module Spec
  module Runner
    module Formatter
      class CustomHtmlFormatter < BaseTextFormatter
        ...
        def example_failed(example, counter, failure)
          ...
          @output.puts "    <script>makeRed('rspec-header');</script>" unless @header_red
          @header_red = true
          @output.puts "    <script>makeRed('example_group_#{example_group_number}');</script>" unless @example_group_red
        ...
        def example_pending(example, message, deprecated_pending_location=nil)
          @output.puts "    <script>makeYellow('rspec-header');</script>" unless @header_red
          @output.puts "    <script>makeYellow('example_group_#{example_group_number}');</script>" unless @example_group_red
          move_progress
        ...
        def move_progress
          @output.puts "    <script>moveProgressBar('#{percent_done}');</script>"
          @output.flush
        end
        ...
        def dump_summary(duration, example_count, failure_count, pending_count)
          ...
          @output.puts "<script>document.getElementById('duration').innerHTML = \"Finished in <strong>#{duration} seconds</strong>\";</script>"
