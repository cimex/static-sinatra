...
<p>As you may realise, the static content has not been built yet in this repo, so you will need to cd to the root and run <code>rake build</code> before the tests will have anything to test.</p>
